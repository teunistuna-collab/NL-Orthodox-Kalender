...
const DAYS: Array<{ key: DayKey; label: string; short: string; Icon: LucideIcon }> = [
  { key: 'zondag', label: 'Zondag', short: 'De Verrijzenis van Christus', Icon: Sun },
  { key: 'maandag', label: 'Maandag', short: 'De engelen en hemelse machten', Icon: Feather },
  { key: 'dinsdag', label: 'Dinsdag', short: 'Johannes de Voorloper', Icon: Droplet },
  { key: 'woensdag', label: 'Woensdag', short: 'Het verraad en het heilig Kruis', Icon: CrossIcon },
  { key: 'donderdag', label: 'Donderdag', short: 'De apostelen en H. Nicolaas', Icon: Users },
  { key: 'vrijdag', label: 'Vrijdag', short: 'De Kruisiging van de Heer', Icon: Mountain },
  { key: 'zaterdag', label: 'Zaterdag', short: 'De heiligen en ontslapenen', Icon: Moon },
];
...
const INFO_CARDS: Array<{ key: InfoKey; title: string; intro: string; Icon: LucideIcon }> = [
  { key: 'wat', title: 'Wat is de weekcyclus?', intro: 'De week is de ademhaling van het kerkelijk leven, geworteld in de Verrijzenis van Christus.', Icon: Sun },
  { key: 'dagen', title: 'De dagen van de week', intro: 'Elke dag van de week heeft een eigen liturgisch karakter, lezingen en gedenkingen.', Icon: Users },
  { key: 'betekenis', title: 'De geestelijke betekenis', intro: 'De week vormt ons in het leven met Christus: van Verrijzenis tot verwachting.', Icon: CrossIcon },
  { key: 'praktisch', title: 'Praktisch', intro: 'Hoe kun je de weekcyclus meeleven in je gebed, thuis en in de parochie?', Icon: Droplet },
];
