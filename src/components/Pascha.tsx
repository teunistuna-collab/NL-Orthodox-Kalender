...
import { BookOpen, Church, Flame, Sparkles, type LucideIcon } from 'lucide-react';
...
const INFO_CARDS: Array<{ key: InfoKey; title: string; intro: string; Icon: LucideIcon }> = [
  { key: 'wat', title: 'Wat is Pascha?', intro: 'De Verrijzenis van Christus als het hart van het kerkelijk jaar en van ons leven.', Icon: Sparkles },
  { key: 'cyclus', title: 'De Paschale cyclus', intro: 'Van de voorbereidende vasten tot Pinksteren: één beweging van dood naar nieuw leven.', Icon: Church },
  { key: 'betekenis', title: 'De betekenis in ons leven', intro: 'Pascha vernieuwt de tijd, onze blik en ons bestaan.', Icon: Flame },
  { key: 'tradities', title: 'Tradities en viering', intro: 'De rijke schoonheid van de Paasdiensten en de Orthodoxe tradities.', Icon: BookOpen },
];
