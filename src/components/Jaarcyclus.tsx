...
import { Cross as CrossIcon, Droplet, Flame, Star, Sun, Wheat, type LucideIcon } from 'lucide-react';
...
const PERIODS: Array<{ key: PeriodKey; label: string; short: string; Icon: LucideIcon; movable: boolean }> = [
  { key: 'kersttijd', label: 'Kersttijd', short: 'De komst van het Licht in de wereld', Icon: Star, movable: false },
  { key: 'openbaringstijd', label: 'Openbaringstijd', short: 'Christus wordt geopenbaard aan alle volken', Icon: Droplet, movable: false },
  { key: 'vastentijd', label: 'Vastentijd', short: 'Voorbereiding op het heilige Pascha', Icon: Wheat, movable: true },
  { key: 'passietijd', label: 'Passietijd', short: 'Het lijden van de Heer', Icon: CrossIcon, movable: true },
  { key: 'paschatijd', label: 'Paschatijd', short: 'De Verrijzenis van Christus', Icon: Sun, movable: true },
  { key: 'pinkstertijd', label: 'Pinkstertijd', short: 'De gave van de Heilige Geest', Icon: Flame, movable: true },
];
...
const INFO_CARDS: Array<{ key: InfoKey; title: string; intro: string; Icon: LucideIcon }> = [
  { key: 'wat', title: 'Wat is het kerkelijk jaar?', intro: 'Het kerkelijk jaar is de heilige tijd waarin de Kerk het leven van Christus herleeft, van Zijn Geboorte tot Zijn Verrijzenis.', Icon: Star },
  { key: 'jaarcyclus', title: 'De jaarcyclus', intro: 'Het kerkelijk jaar bestaat uit perioden, feesten en vasten die ons stap voor stap meenemen in het heilshandelen van God.', Icon: Sun },
  { key: 'betekenis', title: 'De betekenis in ons leven', intro: 'Het kerkelijk jaar vormt ons hart, richt onze blik op Christus en heiligt onze tijd, dagen en seizoenen.', Icon: CrossIcon },
  { key: 'praktisch', title: 'Praktisch', intro: 'Hoe kun je het kerkelijk jaar meeleven in je gebed, thuis, in de parochie en in het dagelijkse leven?', Icon: Wheat },
];
